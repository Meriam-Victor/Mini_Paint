...
public class LineInfo extends javax.swing.JFrame implements Node{
    ...
    private void initComponents() {
        ...
        yStartingTextField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                yStartingTextFieldActionPerformed(evt);
            }
        });

        xEndingTextField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                xEndingTextFieldActionPerformed(evt);
            }
        });

        yEndingTextField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                yEndingTextFieldActionPerformed(evt);
            }
        });
    ...
    private void yStartingTextFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_yStartingTextFieldActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_yStartingTextFieldActionPerformed

    private void xEndingTextFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_xEndingTextFieldActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_xEndingTextFieldActionPerformed

    private void yEndingTextFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_yEndingTextFieldActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_yEndingTextFieldActionPerformed
